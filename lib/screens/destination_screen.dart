            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(icon: Icon(Icons.arrow_back_ios), onPressed: (){Navigator.of(context).pop();}, iconSize: 30.0,color: Colors.black,),

                    Row(
                      children: [
                        IconButton(icon: Icon(Icons.search), onPressed: (){Navigator.of(context).pop();}, iconSize: 30.0,color: Colors.black,),
                        IconButton(icon: Icon(FontAwesomeIcons.sortAmountDown), onPressed: (){}, iconSize: 25.0, color: Colors.black,)
                        // Icon(FontAwesomeIcons.sortAmountDown), onPressed: (){Navigator.of(context).pop();}, iconSize: 30.0,color: Colors.black,)
                      ],
                    ),
                  ],
                ),
